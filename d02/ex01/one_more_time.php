...
<?php
	if ($argc < 2)
		exit();
	if (!preg_match('/(^(([Mm]ardi)|([Ll]undi)|([Mm]ercredi)|([Jj]eudi)|([Vv]endredi)|([Ss]amedi)|([Dd]imanche)) (?!00)(([0-2][0-9])|([3][0-1])|([0-9])) (([Jj]anvier)|([Ff]evrier)|([Mm]ars)|([Aa]vril)|([Mm]ai)|([Jj]uin)|([Jj]uillet)|([Aa]out)|([Ss]eptembre)|([Oo]ctobre)|([Nn]ovembre)|([Dd]ecembre)) [0-2][0-9]{3} ([0-1][0-9]|2[0-3]):([0-1][0-9]|2[0-3]):[0-5][0-9]$)/', $argv[1]))
	{
		echo "Wrong Format\n";
		exit();
	}
