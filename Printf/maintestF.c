...
/*int y;
int x;
	    y =a+=ft_printf("%.13f et aussi %c fini et puis %.d\n", 0.00003000, 'G', 0);
	    x = a+=ft_printf("%.13f et aussi %c fini et puis %.d\n", 0.00003000, 'G', 0);
	    y =a+=ft_printf("%f et aussi %c fini et puis %.d\n", 0.0001406256066968, 'G', 0);
    x = a+=ft_printf("%f et aussi %c fini et puis %.d\n", 0.0001406256066968, 'G', 0);*/
	return (0);
}
