...
printf("Bb:%010.5d\n", b);
											write(1, "\n", 1);
ft_printf("{be}%s{defa}%%f336 cccc$%%%%e \\t \t \\ \\  \n \n", "oleee");
printf("{be}%s{defa}%%f336 cccc$%%%%e \\t \t \\ \\  \n \n", "oleee");
											write(1, "\n", 1);
	c+=ft_printf("{}{}{ddd}{blu} \n");
	d+=printf("{}{}{ddd}{blu} \n");
											write(1, "\n", 1);
	ft_printf("{blue}%-10s{default} {red}%s{eoc} {green}%-5s{eoc} %s\n", "Blue","red","green", "default\n");
	printf("%-10s %s %-5s %s\n", "Blue","red","green","default\n");
											write(1, "\n", 1);
	ft_printf("{blue}%-10s{default} {blue}%s{eoc} {green}%-5s{eoc} %s\n", "Blue","red","green", "default\n");
	printf("%-10s %s %-5s %s\n", "Blue","red","green","default\n");
											write(1, "\n", 1);
